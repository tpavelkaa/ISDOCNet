namespace ISDOCNet.Console
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var fileSavePath = @"C:\isdoc\output\output.isdoc";
            ...
            var invoice = Sample.SimpleInvoiceVat.Create(handler.GetDocument(9, "6df6782b-709d-4f31-9ae0-931a35a0e39e", "e5957e43-9e80-4ebd-a646-6edb08d9eb58"));
